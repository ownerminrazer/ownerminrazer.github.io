...
;(function ($, window, undefined) {
  ...
  VideoWrapper.prototype.init = function (options) {
    ...
    if (videoType === 'youtube') {
      ...
      that.__ytStartPlaysinline = !!options.playsinline || options.playsinline === undefined;
      ...
      $video = $('<video>')
        ...
        .prop('playsinline', !!options.playsinline || options.playsinline === undefined)
